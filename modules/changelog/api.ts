...
import { ChangelogResult, GitInfo, PackageInfo, RepositoryFile, Release } from './types'
 ...
 */
export async function parseGitInfo(packageInfo: PackageInfo): Promise<GitInfo | null> {
    try {
        // Dynamic import for hosted-git-info which is a CommonJS module
        const hostedGitInfo = require('hosted-git-info')
        
        const repoUrl = typeof packageInfo.repository === 'string'
