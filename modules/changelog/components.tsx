                        ...
                        <Table>
                            ...
                            <TableBody>
                                <TableRow>
                                    ...
                                    <TableCell>
                                        <Link href={result.npmUrl} target="_blank">
                                            {result.npmUrl}
                                        </Link>
                                    </TableCell>
                                </TableRow>
                                ...
                                {result.homepage && (
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <Link href={result.homepage} target="_blank">
                                                {result.homepage}
                                            </Link>
                                        </TableCell>
                                    </TableRow>
                                ...
                                {result.repositoryUrl && (
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <Link href={result.repositoryUrl} target="_blank">
                                                {result.repositoryUrl}
                                            </Link>
                                        </TableCell>
                                    </TableRow>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell>
                                        {result.changelogUrl ? (
                                            <Link href={result.changelogUrl} target="_blank">
                                                {result.changelogUrl}
                                            </Link>
                                        ) : (
                                            "No changelog found"
                                ...
                                {result.releasesUrl && (
                                    <TableRow>
                                        ...
                                        <TableCell>
                                            <Link href={result.releasesUrl} target="_blank">
                                                {result.releasesUrl}
                                            </Link>
                                        </TableCell>
                                    </TableRow>
